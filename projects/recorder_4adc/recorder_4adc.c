...
int main(int argc, char *argv[])
{
  ...
  rst = (uint8_t *)(cfg + 0);
  printf("Initial cfg %d,  writer %d,  osciloscope %d, flags %d\n",*((uint32_t *)(cfg + 0)),*((uint32_t *)(sts + 0)),*((uint32_t *)(sts + 4)),*((uint16_t *)(sts + 8)));
  /* reset oscilloscope and ram writer */
  *rst &= ~1;
  *rst |= 1;
  printf("After reset %d,  writer %d,  osciloscope %d, flags %d\n",*((uint32_t *)(cfg + 0)),*((uint32_t *)(sts + 0)),*((uint32_t *)(sts + 4)),*((uint16_t *)(sts + 8)));
  ...
  *rst |= 2;
  *rst &= ~2;
  printf("After start %d,  writer %d,  osciloscope %d, flags %d\n",*((uint32_t *)(cfg + 0)),*((uint32_t *)(sts + 0)),*((uint32_t *)(sts + 4)),*((uint16_t *)(sts + 8)));

  usleep(10000);
  start = *(uint32_t *)(sts + 0) ;
  printf("After delay cfg %d,  writer %d,  osciloscope %d, flags %d\n",*((uint32_t *)(cfg + 0)),*((uint32_t *)(sts + 0)),*((uint32_t *)(sts + 4)),*((uint16_t *)(sts + 8)));
  ...
  start = *(uint32_t *)(sts + 0) ;
  printf("After trigger cfg %d,  writer %d,  osciloscope %d, flags %d\n",*((uint32_t *)(cfg + 0)),*((uint32_t *)(sts + 0)),*((uint32_t *)(sts + 4)),*((uint16_t *)(sts + 8)));
