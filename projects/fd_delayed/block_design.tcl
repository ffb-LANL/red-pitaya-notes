...
# Create xlconstant
cell xilinx.com:ip:xlconstant:1.1 const_key {
  CONST_WIDTH 16
  CONST_VAL 8191
}
...
# Create not gate
cell xilinx.com:ip:util_vector_logic:2.0 not_gate {
  C_SIZE 1
  C_OPERATION not
} {
...
# Create axis_keyer
cell pavel-demin:user:axis_keyer:1.0 keyer_dac {
  AXIS_TDATA_WIDTH 16
} {
  S_AXIS dds_0/M_AXIS_DATA
  aclk ps_0/FCLK_CLK0
  key_flag not_gate/res
  key_data const_key/dout
}
