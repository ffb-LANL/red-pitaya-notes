...
(* CORE_GENERATION_INFO = "DUT_IV,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=DUT_IV,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=2,numReposBlks=2,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "DUT_IV.hwdef" *) 
module DUT_IV
   (M_AXIS_tdata,
    M_AXIS_tlast,
    M_AXIS_tready,
  ...
  wire aclk_1;
  wire aresetn_1;
  wire [17:0]axis_measure_pulse_0_BRAM_PORTA_ADDR;
