...
(* CORE_GENERATION_INFO = "dut_4,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dut_4,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "dut_4.hwdef" *) 
module dut_4
   (M_AXIS_tdata,
    M_AXIS_tready,
    M_AXIS_tvalid,
  ...
  dut_4_axis_register_slice_0_0 axis_register_slice_0
       (.aclk(Net1),
        .aresetn(Net),
  ...
  dut_4_dds_compiler_0_0 dds_compiler_0
       (.aclk(Net1),
        ...
        .s_axis_config_tdata(axis_register_slice_0_M_AXIS_TDATA),
        .s_axis_config_tready(axis_register_slice_0_M_AXIS_TREADY),
        .s_axis_config_tvalid(axis_register_slice_0_M_AXIS_TVALID));
endmodule
